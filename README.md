...
●	Linux / Windows Server Environments<br>
●	System Monitoring & Log Analysis (Splunk)<br>
●	Troubleshooting & Issue Investigation<br>
●	Git / SVN Source Control (usage & maintenance)<br>
●	Database Systems (PostgreSQL, MySQL, MariaDB, RDBMS)<br>
...
Sep 2024 – Present<br>
●	Designed and operated Automation Anywhere–based RPA workflows supporting data collection, monitoring, and routine operational tasks in semiconductor manufacturing environments.<br>
●	Automated data extraction and validation from Samsung manufacturing and engineering systems using Automation Anywhere–based RPA workflows.<br>
●	Built Windows-based UI automation for legacy engineering applications running in VDI and security-restricted environments by analyzing application behaviors and window interactions.<br>
●	Integrated PowerShell scripts, Python-based data gathering scripts, and native Windows utilities into RPA workflows to support system-level automation, file operations, and data preprocessing.<br>
...
●	Supported system validation and troubleshooting during development, pre-production, and mass production stages for customer mobile devices.<br>
...
●	Supported Bluetooth module manufacturing test software and production validation processes.<br>
●	Analyzed test results and system data to identify defects during mass production.<br>
...
●	Splunk Search Expert 101, Splunk (2024)<br>
●	SQL for Data Science, University of California, Davis (2024)<br>
●	DevOps on AWS Specialization, Amazon Web Services (2024)<br>
●	IT System Administration & Infrastructure Services, Google (2024)<br>
